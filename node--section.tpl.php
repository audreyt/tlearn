...
<?php
    // addmovie here for test, by artt 2013-01-04
    print "Permission:" . render($tlearn_permission) . "<br/>";
    print "Method:" . render($tlearn_method) . "<br/>";
    print "Class Title:" . render($tlearn_class) . "<br/>";
    print "Prev Section:" . render($tlearn_prev_section) . "<br/>";
    print "Next Section:" . render($tlearn_next_section) . "<br/>";
    print render($tlearn_movieshow);
?>
<div class="clear"></div>
